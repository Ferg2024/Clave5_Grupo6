...
namespace Clave5_Grupo6
{
    public class Reserva : Entidad
    {
        ...
        public Reserva(int id, Cliente cliente, Sala sala, DateTime fechaReserva, TimeSpan horaInicio, TimeSpan horaFin, int menuSeleccionado, int cantidadAsistentes, List<string> asistentes, decimal totalPago)
